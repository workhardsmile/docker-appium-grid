#-*- coding:utf-8 -*-
# import sys
# sys.path.append('/Users/Anry/ironhide-test/interface')

from interface.testbasic import *
import json,time,redis,torndb,unittest
...
def test(params,headers=None):
    r = ironhide().interfacetest('/api/mobile/v1/users/sign_up', 'POST', params,headers)
    return r
...
class test_sign_up(myunittest.TestCase):
    #注册
    def test_1(self):
        u"""注册账号"""
        self.case_id = 'test_1'
